...
- Please remember to secure the EC2's private key and the User's credential.  Furthermore, public IP address was temporarly allowed into the EC2 for test and learnin purposes. 
